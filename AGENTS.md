...
| 3 — Motor autoritativo online | Parte 3a (sala, ticket, lobby) implementada; nova validação manual integrada em dois navegadores pendente; 3b (motor físico) e 3c (classificação e fluxo de corrida) pendentes |
